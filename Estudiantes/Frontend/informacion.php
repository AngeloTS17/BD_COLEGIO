...
$query_curso_prueba = "SELECT * FROM matriculas WHERE matriculas.id_estudiante = $idEst";
$result_curso = mysqli_query($link, $query_curso_prueba);
...
<body>
    ...
    <main class="container">
        ...
        <section class="section foto">
            ...
            <div class="text">
                <div class="img-container">
                    <img src="../Backend/Fotos/<?php echo $foto; ?>" alt="Foto de perfil">
                </div>
            </div>
        </section>
        ...
        <section class="section" >
            ...
            <div class="text">
                <ul>
                    <?php while ($row = mysqli_fetch_array($result_curso)): ?>
                    <?php $query_curso_nombre = "SELECT * FROM cursos WHERE cursos.id_curso= $row[id_curso]";
                    $result_nombre = mysqli_query($link, $query_curso_nombre);
                    $row_nombre = mysqli_fetch_array($result_nombre);?>
                <li><?php echo $row_nombre["nombre_curso"] ?></li>
                <?php endwhile; ?>
                </ul>
            </div>
        </section>

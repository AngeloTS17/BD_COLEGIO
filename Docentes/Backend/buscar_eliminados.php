...
if (isset($_POST['query'])) {
    ...
    $query_select = "SELECT * FROM docentes WHERE docentes.borrado = 1 AND (dni LIKE '%$query%' OR nombres LIKE '%$query%' OR apellidoPaterno LIKE '%$query%' OR apellidoMaterno LIKE '%$query%')";
